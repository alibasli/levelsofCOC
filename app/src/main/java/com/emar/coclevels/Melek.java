...
public class Melek extends Activity implements View.OnClickListener {
    ...
    public void init() {
        ...
        melek1 = (ImageButton) findViewById(R.id.melek1);
        melek2 = (ImageButton) findViewById(R.id.melek2);
        ...
        LayoutInflater inflater = (LayoutInflater) Melek.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public void popupInit() {
        ...
        melek1.setOnClickListener(this);
        melek2.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.melek1) {

            popupPencere.showAtLocation(layoutOfPopup, Gravity.CENTER, 0, 0);
            r1c2.setText("35 - 42");
            r2c2.setText("500 - 600");
            r3c2.setText("5k - 6k");
            r4c2.setText("N/A - 750k");
            r5c2.setText("N/A - 5");
            r6c2.setText("N/A - 3d");


        }
        else if(v.getId()== R.id.melek2){

            popupPencere.showAtLocation(layoutOfPopup, Gravity.CENTER, 0, 0);
            r1c2.setText("55 - 71");
            r2c2.setText("840 - 1176");
            r3c2.setText("6k - 10k");
            r4c2.setText("1.5M - 3M");
            r5c2.setText("6 - 7");
            r6c2.setText("5d - 7d");
        }
        else {
