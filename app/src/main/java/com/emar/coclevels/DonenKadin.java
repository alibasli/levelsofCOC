...
public class DonenKadin extends Activity implements View.OnClickListener {
    ...
    ImageButton donenkadin1;
    ImageButton donenkadin2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.donen_kadin);
    ...
    public void init() {
        ...
        donenkadin1 = (ImageButton) findViewById(R.id.donenkadin1);
        donenkadin2 = (ImageButton) findViewById(R.id.donenkadin2);
        ...
        LayoutInflater inflater = (LayoutInflater) DonenKadin.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public void popupInit() {
        ...
        donenkadin1.setOnClickListener(this);
        donenkadin2.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        else if(v.getId()== R.id.donenkadin2){

            popupPencere.showAtLocation(layoutOfPopup, Gravity.CENTER, 0, 0);
            r1c2.setText("111 - 124");
            r2c2.setText("1.1k - 1.2k");
            r3c2.setText("130 - 160");
            r4c2.setText("60k - 70k");
            r5c2.setText("7 - 7");
